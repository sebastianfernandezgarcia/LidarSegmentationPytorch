...
class ParisDataset(data.Dataset):
    ...
    def __init__(self, root, npoints=5000,datapath=r'C:/Users/sfernandez/nueva_etapa/github2/LidarSegmentationPytorch/Datasets/Aerolaser/'): #datapath='split_de_paris10clases/reduced10k/normalized')
