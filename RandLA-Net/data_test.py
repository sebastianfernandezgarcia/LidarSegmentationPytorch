...
def data_loaders_original(dir, sampling_method='active_learning', **kwargs):
    ...
    if sampling_method == 'naive':
        ...
        #train_dataset = PointCloudsDataset('dataset_final_pruebas_balanceo_8/train/train/')     #('dataset_final/train/train/')      #('dataset_final_pruebas_balanceo_2/train/train/')
        #val_dataset = PointCloudsDataset(dir / 'validation')
        ...
        test_dataset = PointCloudsDataset(r'C:/Users/sfernandez/nueva_etapa/github2/LidarSegmentationPytorch/Datasets/Aerolaser/test/procesados10metros50000-0_1')  #r'C:/Users/sfernandez/nueva_etapa/github/Datasets/Aerolaser/test/procesados50000-0_1')
