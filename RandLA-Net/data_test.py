...
def data_loaders_original(dir, sampling_method='active_learning', **kwargs):
    ...
    if sampling_method == 'naive':
        ...
        test_dataset = PointCloudsDataset(r'C:/Users/sfernandez/nueva_etapa/github2/LidarSegmentationPytorch/Datasets/Aerolaser/test/procesados50000-0_1')  #r'C:/Users/sfernandez/nueva_etapa/github/Datasets/Aerolaser/test/procesados50000-0_1')
