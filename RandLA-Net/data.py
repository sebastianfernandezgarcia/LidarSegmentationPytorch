...
def data_loaders(dir, sampling_method='active_learning', **kwargs):
    ...
    if sampling_method == 'naive':
        ...
        print("Rango 0, 1")
        train_dataset = PointCloudsDataset(r'C:/Users/sfernandez/nueva_etapa/github/Datasets/Aerolaser/train/train/procesados50000-0_1') #overfit50k-1/')#train/train/procesados50000-0_1/')    #('dataset_final/train/train/')  
        ...
        val_dataset = PointCloudsDataset(r'C:/Users/sfernandez/nueva_etapa/github/Datasets/Aerolaser/train/validation/procesados50000-0_1') #overfit50k-1/')#train/validation/procesados50000-0_1/') #('dataset_final/train/validation/') #
        test_dataset = PointCloudsDataset(r'C:/Users/sfernandez/nueva_etapa/github/Datasets/Aerolaser/test/procesados50000-0_1') #overfit50k-1/')#test/procesados50000-0_1/') #('dataset_final/test/') #('dataset_final_pruebas_balanceo_2/test/')
