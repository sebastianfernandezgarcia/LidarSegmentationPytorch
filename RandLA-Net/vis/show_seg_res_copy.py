...
parser.add_argument('--dataset', type=str, default=r'dataset_final_pruebas_balanceo_2/test/', help='dataset path')
...
#view_points_labels(all_original_points, all_gt_labels, all_gt_labels)

#print('View diff labels ..')
#view_points_labels(all_original_points, all_diff_labels, all_gt_labels, diff=True)

print('View pred labels ..')
view_points_labels(all_original_points, all_pred_labels, all_gt_labels)
