...
def mini_color_table(index, diff, norm=True):
    colorsANTES = [
        ...
        [0.9900, 0.9900, 0.0000], [0.5000, 0.4000, 0.9900], [0.0000, 0.0000, 0.0000], [0.5000, 0.2500, 0.0000]
    ]

    colors = [
        [0.5000, 0.5, 0.5], [0.0000, 0.0000, 0.0000], [0.700, 0.7000, 0.7000],
    ...
    if diff:
        colors = [
            ...
            [0.99,0.99,0], [0.15,0.09,0.9], [0.0000, 0.0000, 0.0000], [0.0000, 0.0000, 0.0000],
        ]

    else:
        colors = [
            [0.000, 0.0, 0.0], [0.5000, 0.2500, 0.0000], [0.00, 0.0000, 1.00],
