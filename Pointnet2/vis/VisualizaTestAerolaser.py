...
view_points_labels(all_original_points, all_gt_labels, all_gt_labels, tipodataset=True)

print('View diff labels ..')
view_points_labels(all_original_points, all_diff_labels, all_gt_labels, diff=True, tipodataset=True)
